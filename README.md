# openfoam package for void linux

this is the unofficial repo for openfoam for void linux

## Installing a release
### Installing through the repository
If you want to update openfoam along with your distribution packages, just run
the following commands once:
```
$ su
# echo 'repository=https://github.com/muezabdalla/openfoam-void/releases/latest/download/' > /etc/xbps.d/30-openfoam.conf
# xbps-install -Su openfoam
```
...
```
$ git clone https://github.com/muezabdalla/openfoam-void.git
```
